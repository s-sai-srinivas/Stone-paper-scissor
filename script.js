...
const getNext = document.querySelectorAll(".next");
...
function displayscore() {
  if (localStorage.clickcount !== undefined && localStorage.clickcount2 !== undefined) {
...
function showResultPage() {
  if (localStorage.clickcount == localStorage.clickcount2){
    window.location.href = "gameTie.html";
  }
  else if (localStorage.clickcount > localStorage.clickcount2) {
